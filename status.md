...
- **push ล่าสุด: `c09e981`** — ระบบแชร์ไดนามิก + แทบสีมือถือ + crop แอดมิน + แก้ขนาดกลุ่ม
- เว็ปจริง Vercel = โค้ดล่าสุด · ไม่มีงานค้าง push · rotate key เสร็จ ✅
- ⚠️ **serverless ครั้งแรก** (api/og, api/share) — หลัง deploy ต้องเทสว่า sharp/functions ทำงานบน Vercel จริง
